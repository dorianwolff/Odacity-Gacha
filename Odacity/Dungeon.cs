...
public class Dungeon
{
    ...
    public static int questStageClear;
    ...
    public static void DisplayHighScores(List<Character> characterCollection, bool fromVictory)
    {
        ...
        Console.WriteLine("/-------------------------------------------\\\n" +
                          ...
                          "|                 \u001b[36mHighScores\u001b[0m                |\n" +
                          "|                                           |");
        Console.WriteLine("|            Current quest clear : " + q + "      |\n" +
                          "|                                           |");
    ...
    public static void EnterDungeon(List<Character> characterCollection)
    {
        ...
        switch (keyInfo.Key)
        {
            ...
            case ConsoleKey.Q:
                ...
                {
                    EnterQuest(characterCollection);
                }
                //Quest
                return;
            case ConsoleKey.T:
    ...
    public static void EnterQuest(List<Character> characterCollection)
    {
        string questStage = questStageClear+"";
        if (questStageClear < 10)
        {
            questStage += "  ";
        }
        if (questStageClear < 100)
        {
            questStage += " ";
        }
        else if (questStageClear==101)
        {
            Console.WriteLine("/-------------------------------------------\\\n" +
                              "|                                           |\n" +
                              "|                   \u001b[36mQuest\u001b[0m                   |\n" +
        ...
        Console.WriteLine("/-------------------------------------------\\\n" +
                          ...
                          "|                                           |\n" +
                          "|                                           |\n" +
                          "|  Please press \u001b[36m(q)\u001b[0m to proceed to stage \u001b[31m"+questStage+"\u001b[0m|\n" +
                          "|                                           |\n" +
                          "|                                           |\n" +
                          "|                  \u001b[34mBack(b)\u001b[0m                  |\n" +
                          "\\-------------------------------------------/\n");
        ...
        switch (keyInfo.Key)
        {
            ...
            case ConsoleKey.Q:
                Console.Clear();
                Quest.StartQuest(characterCollection);
                break;
            default:
                // Invalid input
                Console.Clear();
