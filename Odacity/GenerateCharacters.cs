...
public class GenerateCharacters
{
    ...
    public static string GenerateEnemyName()
    {
        string[] names =
        {
            "Hodor", "Alain", "Jean", "Hob", "Roddy", "Marie", "Flaure", "Rain",
            "Fright", "Fred", "Art", "Laurius", "Lord", "Lyndis", "Magnius",
            "George", "Nyx", "Apollo", "Athena", "Zeus", "Odin", "Hercules"
        };
    ...
    public static string GenerateEnemyNickname()
    {
        string[] nickNames =
        {
            "Great", "Brave", "Sheltered", "Injured", "Vincible", "Paladin", "Priest",
            "Corrupted", "Mage", "All-knowing", "Bard", "Caring", "Miserable", "Killer",
            "Murderer", "Demon", "Patriarch", "Manipulator", "Knight"
        };

        Random rd = new Random();
        int nameIndex = rd.Next(0, nickNames.Length);

        return nickNames[nameIndex];
    }
    ...
    public static Skill GenerateEnemyUltSkill(string grade) //needs color
    {
        ...
        string[] Ultname =
        {
            ...
            "Me>>You", "Shrekt", "Get dunked", "Purgatory", "Divinity's embrace", "Mortal slumber",
            "Thanks and bye", "Skill issue", "Muscle power", "Dark mist"
